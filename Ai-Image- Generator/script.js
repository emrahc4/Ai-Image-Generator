const apiKey = "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";
...
window.onload = function() {
    // Kapak ekranı gösteriliyor
    const coverScreen = document.getElementById("cover-screen");

    // 3 saniye sonra kapak ekranını gizle
    setTimeout(() => {
        coverScreen.classList.add("hidden"); // Kapak ekranını gizle
        document.querySelector(".container").style.display = "block"; // Ana içeriği göster
